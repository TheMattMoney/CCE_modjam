...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Team Topaz'],
			['Matt$',					'cyrix',			'Director/ Musician/ Charter',												'https://mattmoney.newgrounds.com',		'88DE30'],
			['Liminalstarboy',			'majii',			'Background Artist/ Character Design Assistant/ Topaz VA #1',	'https://twitter.com/liminalstarboy',	'DA9E7F'],
			...
			['Sykley',					'shadowmario',		'Topaz VA #2',													'https://twitter.com/SykleyShbang',		'110F10'],
